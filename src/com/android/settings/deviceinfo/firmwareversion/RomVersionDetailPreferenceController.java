...
public class RomVersionDetailPreferenceController extends BasePreferenceController {
    ...
    private static final Uri INTENT_URI_DATA = Uri.parse("https://bit.ly/zjrdroid_paypal");
    private static final String TAG = "romDialogCtrl";
    private static final String KEY_ROM_VERSION_PROP = "org.moon.build_version";
    private static final String KEY_ROM_RELEASETYPE_PROP = "org.moon.build_type";
